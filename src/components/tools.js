        ...
        <div className="development-tools">
            ...
            <div className="tools">
                <div className="vsCode tools-div">
                    ...
                    <h4><a href='https://code.visualstudio.com/' target='_blank'>Visual Studio Code</a></h4>
                ...
                <div className="vsCodeExt tools-div">
                    <h3><VscExtensions /></h3>
                    <h4><a href='https://github.com/pranam1603/vsCode-Extensions' target='_blank'>My Visual Studio Code Setup</a> </h4>
